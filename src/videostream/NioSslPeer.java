 ...
 * <p/>
 * {@link NioSslPeer} implements the handshake protocol, required to establish a
 * connection between two peers, which is common for both client and server and
 * provides the abstract {@link NioSslPeer#read(SocketChannel, SSLEngine)} and
 * {@link NioSslPeer#write(SocketChannel, SSLEngine, String)} methods, that need
...
//	protected final Logger log = Logger.getLogger(getClass());
     ...
     * @param engine - the engine that will be used for encryption/decryption of
     * the data exchanged with the other peer.
